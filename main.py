...
def parse_args():
    ...
    args = CLIArguments(
        ...
        clean_up=bool(raw_args.clean_up),
        execution_timeout=int(raw_args.execution_timeout),
        ...
        max_url=int(raw_args.max_url) if raw_args.max_url else None,
        duration=int(raw_args.duration),
        output=raw_args.output,
        boot_timeout=int(raw_args.boot_timeout),
        headless=bool(raw_args.headless),
        ...
        ms_rpc_port=int(raw_args.ms_rpc_port),
        ms_rpc_ssl=bool(raw_args.ms_rpc_ssl),
        ms_rpc_uri=raw_args.ms_rpc_uri,
        ms_rpc_password=raw_args.ms_rpc_password,
        ms_host=raw_args.ms_host,
        ms_srvport=int(raw_args.ms_srvport),
        ms_lport=int(raw_args.ms_lport),
